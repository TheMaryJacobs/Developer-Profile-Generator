...
<html lang="en">
   <head>
      ...
      <div class="wrapper">
          ...
          <img id="profileimage" class="photo-header img" src ="">
          <h1 class= "photo-header h1">Hi!</h1>
          <h1 class ="photo-header h1" id = "username">My name is $data.name </h1>
          
          </div>
      <div class = "links-nav">
      <a href= "" class = "link-nav"></a>
          <a href = "" id = "profilelink" class = "nav-link"></a>
      ...
      <div class="row">
        <div class="col">
          <h2 class="" id="bio">Hi I'm $data.name</h2>
        </div>
      </div>
      </div>
